...
def quelle_liste():
    ...
    if action == 'O':
        ...
        if len(listes_existantes)==0:
            ...
            nom_liste = input("Veuillez entrer un nom parmi les listes existantes : ")
            while not os.path.exists('fichiers_exos_bases/'+nom_liste):
                nom_liste = input("Cette liste n'existe pas, veuillez vérifier l'orthographe et entrer un nom parmi les listes existantes : ")
